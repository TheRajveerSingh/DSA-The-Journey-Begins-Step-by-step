...
int main(){
    ...
    int B;
    cin>>B;
    cout<<"The total number of steps the Bishop can take from its current box ("<<A<<","<<B<<") is: "<<Solution(A,B);
}
/*
Result:
Enter the row of the bishop: 5
Enter the coloumn of the bishop: 6
The total number of steps the Bishop can take from its current box (5,6) is: 11
Enter the row of the bishop: 1
Enter the coloumn of the bishop: 1
The total number of steps the Bishop can take from its current box (1,1) is: 7
*/